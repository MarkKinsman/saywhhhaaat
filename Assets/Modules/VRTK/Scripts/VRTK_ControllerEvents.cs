...
namespace VRTK
{
    ...
    public class VRTK_ControllerEvents : MonoBehaviour
    {
        ...
        public ButtonAlias teleporterToggleButton = ButtonAlias.Touchpad_Press;
        public ButtonAlias miniModelToggleButton = ButtonAlias.Application_Menu;
        public ButtonAlias cameraRigGrabToggle = ButtonAlias.Trigger_Click;
        ...
        [HideInInspector]
        public bool teleporterPressed = false;

        [HideInInspector]
        public bool miniModelPressed = false;

        [HideInInspector]
        public bool cameraRigGrabPressed = false;
        ...
        public event ControllerInteractionEventHandler AliasTeleporterOn;

        public event ControllerInteractionEventHandler AliasTeleporterOff;

        public event ControllerInteractionEventHandler AliasMiniModelOn;

        public event ControllerInteractionEventHandler AliasMiniModelOff;

        public event ControllerInteractionEventHandler AliasCameraRigGrabOn;

        public event ControllerInteractionEventHandler AliasCameraRigGrabOff;
        ...
        public virtual void OnAliasTeleporterOn(ControllerInteractionEventArgs e)
        {
            if (AliasTeleporterOn != null)
            {
                AliasTeleporterOn(this, e);
            }
        }

        public virtual void OnAliasTeleporterOff(ControllerInteractionEventArgs e)
        {
            if (AliasTeleporterOff != null)
            {
                AliasTeleporterOff(this, e);
            }
        }

        public virtual void OnAliasMiniModelOn(ControllerInteractionEventArgs e)
        {
            if (AliasMiniModelOn != null)
            {
                AliasMiniModelOn(this, e);
            }
        }

        public virtual void OnAliasMiniModelOff(ControllerInteractionEventArgs e)
        {
            if (AliasMiniModelOff != null)
            {
                AliasMiniModelOff(this, e);
            }
        }

        public virtual void OnCameraRigGrabOn(ControllerInteractionEventArgs e)
        {
            if (AliasCameraRigGrabOn != null)
            {
                AliasCameraRigGrabOn(this, e);
            }
        }

        public virtual void OnCameraRigGrabOff(ControllerInteractionEventArgs e)
        {
            if (AliasCameraRigGrabOff != null)
            {
                AliasCameraRigGrabOff(this, e);
            }
        }
        ...
        private void EmitAlias(ButtonAlias type, bool touchDown, float buttonPressure, ref bool buttonBool)
        {
            ...
            if (teleporterToggleButton == type)
            {
                if (touchDown)
                {
                    teleporterPressed = true;
                    OnAliasTeleporterOn(SetButtonEvent(ref buttonBool, true, buttonPressure));
                }
                else
                {
                    teleporterPressed = false;
                    OnAliasTeleporterOff(SetButtonEvent(ref buttonBool, false, buttonPressure));
                }
            }

            if (miniModelToggleButton == type)
            {
                if (touchDown)
                {
                    miniModelPressed = true;
                    OnAliasMiniModelOn(SetButtonEvent(ref buttonBool, true, buttonPressure));
                }
                else
                {
                    miniModelPressed = false;
                    OnAliasMiniModelOff(SetButtonEvent(ref buttonBool, false, buttonPressure));
                }
            }

            if (cameraRigGrabToggle == type)
            {
                if (touchDown)
                {
                    cameraRigGrabPressed = true;
                    OnCameraRigGrabOn(SetButtonEvent(ref buttonBool, true, buttonPressure));
                }
                else
                {
                    cameraRigGrabPressed = false;
                    OnCameraRigGrabOff(SetButtonEvent(ref buttonBool, false, buttonPressure));
                }
            }
